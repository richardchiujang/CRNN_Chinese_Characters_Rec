...
def parse_arg():
    ...
    parser.add_argument('--checkpoint', type=str, default='output/360CC/checkpoints/checkpoint_349_acc_0.9797.pth',
...
if __name__ == '__main__':
    ...
    imgs_path = glob.glob(os.path.join(args.image_path, '*.jpg'))
    started = time.time()

    for img_path in imgs_path:
        # print('image_path: {0}'.format(img_path))
